...
public class LoadingPage {
    ...
    private void initialize() {
        ...
        logo.setIcon(new ImageIcon(LoadingPage.class.getResource("/images/Group 118.png")));
    ...
    private void startProgressBar() {
    	timer = new Timer(40, event -> {
    	    if (progressValue >= 100) {
    	        ...
    	        try {
    	            PercentageFont = Font.createFont(Font.TRUETYPE_FONT, new File("C:\\Users\\mateo\\eclipse-workspace\\PROJECT\\src\\Main_Project\\NunitoSans_7pt_Condensed-ExtraBold.ttf"));
    	    ...
    	    Font PawFont = null;
            try {
            	PawFont = Font.createFont(Font.TRUETYPE_FONT, new File("C:\\Users\\mateo\\eclipse-workspace\\PROJECT\\src\\Main_Project\\NunitoSans_7pt_Condensed-ExtraBold.ttf"));
                GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
